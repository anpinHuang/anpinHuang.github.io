...
Under the IFRS 9, the loan loss provisioning (ECL) are different from the Basel requirements in the following 3 aspects.
...
The summary of significant increase in credit risk is discussed the the following bullet points with corresponding text from the regulatory documents and references.
