...
```{r}
count(churnAnalysis,'Churn') ## library plyr
...
table(Predicted = pred_tree, Actual = churnAnalysisTest$Churn)
count(churnAnalysisTest,'Churn') ## library plyr
```
...
print("Confusion Matrix for Decision Tree")
table(Predicted = pred_fitTree, Actual = churnAnalysisTest$Churn)
```
