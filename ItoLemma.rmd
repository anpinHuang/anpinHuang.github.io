...
The 3rd step is an important property of the Wiener process and will be shown in the following paragraph.
...
& \to n \cdot E[(W_{t_i}-W_{t_{i-1}})^2]\\
&= n \cdot Var(W_{t_i}-W_{t_{i-1}}) \\
&= n \cdot \frac{t}{n} = t\\
\end{aligned}
$$

By taking the derivative, we can derive that $dW_t = dt$
