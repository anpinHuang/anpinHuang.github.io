...
### Gradient Boosting for continuous target variable
...
### Gradient Boosting for binary target variable
Similar to gradient boosting for continunous target variable, but the loss function is different
**Loss function**
