...
E[P|x=c] &=  E[\frac{1}{1+e^{-(\alpha + x\beta + \epsilon)}}|x=c]\\
 &= \int \frac{1}{1+e^{\alpha+\beta c + \epsilon}} \frac{1}{\sigma\sqrt{2\pi}} \cdot e^{\frac{1}{2}(\frac{x}{\sigma})^2} dx \\
\end{aligned}
$$

To solve this analytically seems difficult if not impossible (at least for me...). So, here I would like to do a simulation to estimate it.
