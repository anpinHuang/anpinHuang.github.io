...
$$E[Loss_p|Z] = \sum_{i=1}^{n} EAD_i \cdot LGD_i \cdot \mathcal{N}(\frac{\Phi^{-1}(PD_i^{*})-\sqrt{\rho}Z}{\sqrt{1-\rho}})$$
...
$$ 
\begin{aligned}
K &= \left(LGD_{downturn} \cdot VaR(\alpha) - EL \right) \cdot MAF \\
&= \left(LGD_{downturn} \cdot VaR(\alpha) - LGD_{downturn} \cdot PD_{TtC}\right) \cdot MAF  \\
