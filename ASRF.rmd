...
The Merton's model can be extended to Asymptotic Single Risk Factor (ASRF) model, assuming the assets value any single borrowing company is correlated that of any other company with correlation $\rho$ ASRF model is portfolio-invariant.
