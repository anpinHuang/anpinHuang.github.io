...
* If the interest rate to the clients are not competitative compared to the peer, the model might suffer from adverse selection. If the interest rates that this company offers decrease in general, the charasteristic of the applicants might change, and thus impact the representitativeness of the historical data
* If the model includes variables that are controlled by the company strategy, then a strategy change would impact the relationship between the default rate & the explanatory variable.
